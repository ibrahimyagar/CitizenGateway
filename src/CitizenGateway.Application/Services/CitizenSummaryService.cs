...
/// </summary>
public sealed class CitizenSummaryService
{
    ...
    {
        // Domain VO: geçersiz TC use case'e girmeden elenir.
        ...
        // Task.WhenAll: üç HTTP çağrısı eşzamanlı — toplam süre ≈ en yavaş servis.
    ...
    private async Task<ServiceCallResult<T>> SafeCallAsync<T>(string serviceName, Func<Task<T?>> call)
    {
        ...
        {
            // 404 null döner (başarı); burada yakalananlar timeout/5xx/circuit breaker.
